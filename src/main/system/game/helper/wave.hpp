...
namespace game::system::helper
{
	...
	public:
		...
		// 生成指定波次(仅此而已)
		static auto spawn(entt::registry& registry, component::wave::WaveIndex wave_index) noexcept -> void;

		// 从指定波次开始
		static auto start_at(entt::registry& registry, component::wave::WaveIndex wave_index) noexcept -> void;
